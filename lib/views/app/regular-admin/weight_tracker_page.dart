      ...
      builder: (context, watch, _){
        ...
        return weightValuesProvider.when(
          data: (value){
            ...
            List<WeightValue> _value = value.isEmpty
              ? [
                  // WeightValue(value: 0, dateTime: DateTime.now())
                ]
              : value.where((element){
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Font.out(
                                              value.isEmpty ? 0.toString() : value[0].value.toInt().toString(), //value
                                              fontSize: 28,
