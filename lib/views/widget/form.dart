...
class LocalForm extends StatefulWidget {
  ...
  LocalForm({required this.emailController, required this.passwordController});
      ...
      children: [
          ...
          child: TextField(
            ...
            decoration: new InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(
                  borderSide:
                      BorderSide(color: Palette.secondaryBorder, width: 1.25),
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: new InputDecoration(
              suffixIcon: Padding(
                padding: EdgeInsets.only(right: MQuery.width(0.01, context)),
                child: IconButton(
